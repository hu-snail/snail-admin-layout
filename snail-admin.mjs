...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const initTabBar = () => {
      let tabs2 = tabsRef.value;
      let getStyle = getComputedStyle(tabs2.children[0].children[0], null);
      ...
      tabOption.width = marginLeft + marginRight + tabs2.children[0].children[0].offsetWidth;
      tabOption.unoccupied = tabs2.offsetWidth % tabOption.width;
      ...
      tabOption.tabsCount = parseInt(tabs2.offsetWidth) / tabOption.width;
    };
    const clickTab = (path) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$c, [
        createElementVNode("div", {
          ...
          createElementVNode("div", _hoisted_2$c, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(tabList.value, (item, index2) => {
              return openBlock(), createElementBlock("div", {
                ...
                createVNode(_component_el_icon, {
                  class: "icon-close",
                  onClick: withModifiers(($event) => closeTab(item.path, index2), ["stop"])
                }, {
                  default: withCtx(() => [
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      ...
      return !__props.item.meta || !__props.item.children ? (openBlock(), createBlock(_component_el_menu_item, {
        ...
        default: withCtx(() => [
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.item.children, (option, index2) => {
...
const SnailLayout$1 = SnailLayout;
const tabs = "";
const props = {};
const Tabs = defineComponent({
  ...
  setup(props2, {
    ...
    watch(() => tabOption.activeTab, (val) => {
      ...
      nextTick(() => {
        translateX((tabList.value.length - tabOption.tabsCount) * tabOption.width - tabOption.unoccupied);
      });
    });
    onMounted(() => {
      nextTick(() => initTabBar());
    ...
    return () => createVNode("div", {
      ...
      return createVNode("div", {
        ...
        "class": "tab-title"
      }, [item.title]), createVNode(resolveComponent("el-icon"), {
        "class": "icon-close"
      }, {
        default: () => [createVNode(resolveComponent("i-park-close-small"), {
          "theme": "outline",
          "size": "24",
          "fill": "#333"
        }, null)]
...
const SnTabs = Object.assign(Tabs, {
  install: function(app) {
    app.component(Tabs.name, Tabs);
  }
});
const SnTabs$1 = SnTabs;
const components = [SnailLayout$1, SnTabs$1];
const install = (app) => {
  components.forEach((component) => {
    app.use(component.install);
  });
};
const index = { install, SnailLayout: SnailLayout$1, SnTabs: SnTabs$1 };
export {
  SnTabs$1 as SnTabs,
